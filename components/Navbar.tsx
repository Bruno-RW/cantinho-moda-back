...
const Navbar = () => {
    ...
    return (
        <nav className={twMerge("w-72 h-screen overflow-hidden transition-width bg-blue-500", isActive && "w-[60px] active")}>

            <div className="flex items-center gap-x-3.5 text-gray-50 font-medium mt-5 mb-8 ml-3.5 pointer-events-none">
                <FaCrown size={28} />
