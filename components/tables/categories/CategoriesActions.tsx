...
import { CategoriesColumnsProps } from "./CategoriesColumns";

interface CategoriesActionsProps { data: CategoriesColumnsProps };

const CategoriesActions: React.FC<CategoriesActionsProps> = ({ data }) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success("Category ID copied to clipboard", toastStyle);
  };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-x-2">
        ...
        <Tooltip className="text-blue-500" content="Edit">
          <Edit className="text-blue-500 h-4 w-4 cursor-pointer" onClick={() => router.push(`/categories/${data.id}`)} />
        </Tooltip>
