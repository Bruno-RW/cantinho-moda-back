...
import { BrandsColumnsProps } from "./BrandsColumns";

interface BrandsActionsProps { data: BrandsColumnsProps };

const BrandsActions: React.FC<BrandsActionsProps> = ({ data }) => {
  ...
  const onCopy = (id: string) => {
    ...
    toast.success("Brand ID copied to clipboard", toastStyle);
  };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-x-2">
        ...
        <Tooltip className="text-blue-500" content="Edit">
          <Edit className="text-blue-500 h-4 w-4 cursor-pointer" onClick={() => router.push(`/brands/${data.id}`)} />
        </Tooltip>
